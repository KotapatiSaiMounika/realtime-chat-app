...
{/* inputs*/ }
         ...
         type="text" required placedholder="Your Name" className='p-2 border border-gary-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' />

        <textarea onChange={(e)=>setBio(e.target.value)} value={bio} 
        rows={4} required placeholder='Write Profile Bio' className='p-2 border border-gary-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' ></textarea>
